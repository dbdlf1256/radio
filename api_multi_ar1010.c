...
int InitAr1010Dev(ar1010_dev_t* ar, sem_t* sem, chanSel f, uint8_t chan)
{
	if(ar == NULL)
	{
		printf("No Information Of AR1010!\r\n");
 ...
 * @return int 0(성공) / 음수(실패)
 */
int Ar1010Init(ar1010_dev_t* ar, sem_t* sem, chanSel f, uint8_t chan, uint8_t xo_en)
{
	/*
	if(ar == NULL)
	{
